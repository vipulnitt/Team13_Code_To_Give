...
const { registerConselor, loginCounselor, logoutCounselor, getCounselorProfile, updateCounselorPassword, counselingRequest} = require('../controllers/counselorController');
