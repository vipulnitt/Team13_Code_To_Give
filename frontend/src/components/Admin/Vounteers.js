...
const Volunteers = () => {
  ...
  <div className="card bg-dark">
                    <div className="card-header cardHead cardbg1">
                       ...
                       <span className="text-white notification cardHeadText">
                        ...
                        <div className="card-header card-header-inner" data-toggle="collapse"
                            ...
                            <b>Contact Details:</b> {currentSelect&&currentSelect.email}
                            </div>
                        </div>
                        </div>
    ...
    <button className="bg-success text-white ml-3 mt-3" onClick={()=>setCurrentData("0")} ><i  className="bi bi-arrow-return-left"></i>Back</button> 
    </Fragment>);
  }
  return (
    <div>
